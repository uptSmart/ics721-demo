...
$BINARY paths add test-1 uptick_7000-1 test1-nft-uptick_7000-1 -f $PWD/network/relayer/interchain-nft-config/paths/test1-nftuptick_7000-1.json --home $CHAIN_DIR/$RELAYER_DIR
...
$BINARY transact link test1-nft-uptick_7000-1  --src-port nft-transfer --dst-port nft-transfer --order unordered --version ics721-1 --max-retries 3 -d --home $CHAIN_DIR/$RELAYER_DIR
